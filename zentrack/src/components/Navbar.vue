  ...
  <nav class="navbar">
    <div class="navbar-content">
      ...
      <div class="navbar-nav">
        ...
        <router-link to="/habits" class="nav-link" v-if="isAuthenticated">Habits</router-link>
        <router-link to="/entries" class="nav-link" v-if="isAuthenticated">Entries</router-link>
